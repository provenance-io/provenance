...
- [provenance/expiration/v1/tx.proto](#provenance/expiration/v1/tx.proto)
    ...
    - [MsgInvokeExpirationResponse](#provenance.expiration.v1.MsgInvokeExpirationResponse)
...
- [provenance/metadata/v1/events.proto](#provenance/metadata/v1/events.proto)
    ...
    - [EventScopeExpired](#provenance.metadata.v1.EventScopeExpired)
...
<a name="provenance.expiration.v1.MsgInvokeExpirationRequest"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `module_asset_id` | [string](#string) |  | Module asset ID which will have its expiration logic triggered |
| `signers` | [string](#string) | repeated | signers is the list of addresses of those signing this request. |
...
<a name="provenance.expiration.v1.MsgInvokeExpirationResponse"></a>

### MsgInvokeExpirationResponse
...
<a name="provenance.metadata.v1.EventScopeExpired"></a>

### EventScopeExpired
EventScopeExpired is an event message indicating a scope has been expired.


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `scope_addr` | [string](#string) |  | scope_addr is the bech32 address string of the scope id that was expired. |
...
| `ExpireScope` | [MsgExpireScopeRequest](#provenance.metadata.v1.MsgExpireScopeRequest) | [MsgExpireScopeResponse](#provenance.metadata.v1.MsgExpireScopeResponse) | ExpireScope deletes a scope and all associated Records, Sessions. | |
