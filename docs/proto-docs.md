...
| `denom` | [string](#string) |  |  |
| `administrator` | [string](#string) |  |  |
| `net_asset_values` | [NetAssetValue](#provenance-marker-v1-NetAssetValue) | repeated | Net asset values to set. When using the special `usd` denom, the amount represents milli-USD units (musd) where 1000 = $1.00 USD |
...
| `AddNetAssetValues` | [MsgAddNetAssetValuesRequest](#provenance-marker-v1-MsgAddNetAssetValuesRequest) | [MsgAddNetAssetValuesResponse](#provenance-marker-v1-MsgAddNetAssetValuesResponse) | AddNetAssetValues set the net asset value for a marker. Note: When settting NAVs with "usd" denom, amounts are in milli-usd (musd) units where 1000 =$1.00 USD |
...
| `signers` | [string](#string) | repeated |  |
| `net_asset_values` | [NetAssetValue](#provenance-metadata-v1-NetAssetValue) | repeated | Net asset values to set. When using the special `usd` denom, the amount represents milli-USD units (musd) where 1000 = $1.00 USD |
...
| `AddNetAssetValues` | [MsgAddNetAssetValuesRequest](#provenance-metadata-v1-MsgAddNetAssetValuesRequest) | [MsgAddNetAssetValuesResponse](#provenance-metadata-v1-MsgAddNetAssetValuesResponse) | AddNetAssetValues set the net asset value for a scope. Note: When settting NAVs with "usd" denom, amounts are in milli-usd (musd) units where 1000 =$1.00 USD |
