...
| `denom` | [string](#string) |  |  |
| `administrator` | [string](#string) |  |  |
| `net_asset_values` | [NetAssetValue](#provenance-marker-v1-NetAssetValue) | repeated | Net asset values to set. When using the special "usd" denom, the amount represents milli-USD (musd) units where 1000 = $1.00 USD |
...
| `signers` | [string](#string) | repeated |  |
| `net_asset_values` | [NetAssetValue](#provenance-metadata-v1-NetAssetValue) | repeated | Net asset values to set. When using the special "usd" denom, the amount represents milli-USD (musd) units where 1000 = $1.00 USD |
