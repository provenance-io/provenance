...
| `MarketTransferCommitments` | [MsgMarketTransferCommitmentsRequest](#provenance-exchange-v1-MsgMarketTransferCommitmentsRequest) | [MsgMarketTransferCommitmentsResponse](#provenance-exchange-v1-MsgMarketTransferCommitmentsResponse) | MarketTransferCommitment is a market endpoint to transfers committed funds from one market to another. |
