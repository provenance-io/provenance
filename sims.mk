...
test-sim-smart-contracts: runsim
	@echo "Running smart contract simulation..."
	@go test -mod=readonly $(SIMAPP) -run TestSmartContracts \
...
test-sim-custom-genesis-multi-seed: runsim
	...
	@echo "By default, ${HOME}/.provenanced/config/genesis.json will be used."
	@$(BINDIR)/runsim -Genesis=${HOME}/.provenanced/config/genesis.json -SimAppPkg=$(SIMAPP) -ExitOnFail 400 5 TestFullAppSimulation
