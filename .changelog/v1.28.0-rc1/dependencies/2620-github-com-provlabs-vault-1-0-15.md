...
* `cloud.google.com/go` bumped to v0.120.0 (from v0.115.1) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
* `cloud.google.com/go/auth` bumped to v0.16.4 (from v0.9.3) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
...
* `cloud.google.com/go/compute/metadata` bumped to v0.8.0 (from v0.7.0) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
* `cloud.google.com/go/iam` bumped to v1.5.2 (from v1.2.0) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
* `cloud.google.com/go/monitoring` added at v1.24.2 [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
* `cloud.google.com/go/storage` bumped to v1.50.0 (from v1.43.0) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
* `cosmossdk.io/api` bumped to v0.9.2 (from v0.7.6) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
* `cosmossdk.io/collections` bumped to v1.3.1 (from v0.4.0) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
...
* `cosmossdk.io/errors` bumped to v1.0.2 (from v1.0.1) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
...
* `github.com/cosmos/cosmos-sdk` bumped to v0.53.5 (from v0.50.14) but is still replaced by v0.50.14-pio-2 of `github.com/provenance-io/cosmos-sdk` [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
* `github.com/cosmos/ledger-cosmos-go` bumped to v0.16.0 (from v0.14.0) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
...
* `github.com/getsentry/sentry-go` bumped to v0.35.0 (from v0.27.0) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
...
* `github.com/googleapis/enterprise-certificate-proxy` bumped to v0.3.6 (from v0.3.3) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
* `github.com/googleapis/gax-go/v2` bumped to v2.15.0 (from v2.13.0) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
...
* `github.com/klauspost/compress` bumped to v1.18.0 (from v1.17.11) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
...
* `github.com/prometheus/client_golang` bumped to v1.23.0 (from v1.21.0) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
...
* `github.com/prometheus/common` bumped to v0.65.0 (from v0.62.0) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
* `github.com/prometheus/procfs` bumped to v0.16.1 (from v0.15.1) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
* `github.com/provlabs/vault` bumped to v1.0.15 (from v1.0.14) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
...
* `go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc` bumped to v0.61.0 (from v0.54.0) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
...
* `golang.org/x/crypto` bumped to v0.41.0 (from v0.40.0) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
...
* `golang.org/x/mod` bumped to v0.27.0 (from v0.26.0) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
* `golang.org/x/net` bumped to v0.43.0 (from v0.42.0) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
* `golang.org/x/sys` bumped to v0.35.0 (from v0.34.0) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
* `golang.org/x/term` bumped to v0.34.0 (from v0.33.0) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
* `golang.org/x/time` bumped to v0.12.0 (from v0.6.0) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
* `golang.org/x/tools` bumped to v0.36.0 (from v0.35.0) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
* `google.golang.org/api` bumped to v0.247.0 (from v0.196.0) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
* `google.golang.org/genproto` bumped to v0.0.0-20250603155806-513f23925822 (from v0.0.0-20240903143218-8af14fe29dc1) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
* `google.golang.org/genproto/googleapis/rpc` bumped to v0.0.0-20250818200422-3122310a409c (from v0.0.0-20250804133106-a7a43d27e69b) [PR 2620](https://github.com/provenance-io/provenance/pull/2620).
