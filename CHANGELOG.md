...
* https://github.com/provenance-io/provenance/compare/v1.21.0...v1.21.1
...
* Expand and simplify metadata querying. [#169](https://github.com/provenance-io/provenance/issues/169)
  * Removed the `SessionContextByID` and `SessionContextByUUID` endpoints. Replaced with the `Sessions` endpoint.
...
This is the initial beta release for the first Provenance public TESTNET.  This release is not intended for any type of
