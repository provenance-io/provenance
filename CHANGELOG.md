...
* Change `marker` default `UnrestrictedDenomRegex` to `[a-zA-Z][a-zA-Z0-9\-\.]{7,83}` to match testnet and mainnet [#719](https://github.com/provenance-io/provenance/issues/719)
### Client Breaking
