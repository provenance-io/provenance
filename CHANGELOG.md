...
* Enable the node query service TODO: link PR.

### Improvements

* Updated name restrictions documentation [#808](https://github.com/provenance-io/provenance/issues/808)
* Updated Cosmos-SDK to v0.46.3-pio-1 (from v0.46.2-pio-2) TODO: link PR.
...
* Fix the [Dragonberry security advisory](https://forum.cosmos.network/t/ibc-security-advisory-dragonberry/7702) TODO: link PR.
