...
func setup(withGenesis bool, invCheckPeriod uint) (*App, GenesisState) {
	...
	app := New("provenanced", log.NewNopLogger(), db, nil, true, map[int64]bool{}, DefaultNodeHome("provenanced"), invCheckPeriod, encCdc, sdksim.EmptyAppOptions{})
	if withGenesis {
	...
	if !isCheckTx {
		...
		app.InitChain(
			abci.RequestInitChain{
				...
				ConsensusParams: sdksim.DefaultConsensusParams,
...
// account. A Nop logger is set in sdksim.
...
func FundAccount(app *App, ctx sdk.Context, addr sdk.AccAddress, amounts sdk.Coins) error {
