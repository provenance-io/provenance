...
func New(
	...
	app.LedgerKeeper = ledgerkeeper.NewKeeper(appCodec, keys[ledger.StoreKey], runtime.NewKVStoreService(keys[ledger.StoreKey]), app.BankKeeper, app.RegistryKeeper, app.MetadataKeeper)

	app.AssetKeeper = assetkeeper.NewKeeper(
		appCodec, keys[assettypes.StoreKey], app.NFTKeeper, app.BaseApp.MsgServiceRouter(), app.LedgerKeeper, app.RegistryKeeper, app.MarkerKeeper,
	)
	...
	app.mm = module.NewManager(
		...
		assetmodule.NewAppModule(appCodec, app.AssetKeeper, app.BaseApp.MsgServiceRouter()),
