...
func New(
	...
	app.AttributeKeeper = attributekeeper.NewKeeper(
		appCodec, keys[attributetypes.StoreKey], app.GetSubspace(attributetypes.ModuleName), app.AccountKeeper, app.NameKeeper, app.ExpirationKeeper,
	)
	...
	app.mm = module.NewManager(
		...
		expirationmodule.NewAppModule(appCodec, app.ExpirationKeeper),
