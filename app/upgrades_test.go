...
func (s *UpgradeTestSuite) TestUmberRC1() {
	expInLog := []string{
		...
		"INF Setting circuit breaker permissions for testnet.",
		"INF Done setting circuit breaker permissions for testnet.",
...
func (s *UpgradeTestSuite) TestUmber() {
	expInLog := []string{
		...
		"INF Done migrating ibchooks params.",
		"INF Starting module migrations. This may take a significant amount of time to complete. Do not restart node.",
		"INF Setting circuit breaker permissions for mainnet.",
		"INF Done setting circuit breaker permissions for mainnet.",
		"INF Updating IBC AllowedClients.",
		"INF Done updating IBC AllowedClients.",
		"INF Removing inactive validator delegations.",
		"INF Threshold: 21 days",
