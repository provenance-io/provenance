...
func (s *SimTestSuite) TestSimulateMsgAddAttribute() {
	...
	s.Assert().Equal(types.AttributeType_UUID, msg.AttributeType, "msg.AttributeType")
	s.Assert().Equal([]byte("7939cb66-99eb-4d18-a447-84045d87f3c6"), msg.Value, "msg.Value")
