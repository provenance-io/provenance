...
var (
	pattern_Msg_CalculateMsgBasedFees_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"provenance", "tx", "v1", "calculate_msg_fees"}, "", runtime.AssumeColonVerbOpt(false)))
)
