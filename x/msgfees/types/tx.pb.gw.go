...
func RegisterMsgHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MsgServer) error {
	...
	mux.Handle("POST", pattern_Msg_CalculateMsgBasedFees_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Msg_CalculateMsgBasedFees_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Msg_CalculateMsgBasedFees_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterMsgHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MsgClient) error {
	...
	mux.Handle("POST", pattern_Msg_CalculateMsgBasedFees_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Msg_CalculateMsgBasedFees_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Msg_CalculateMsgBasedFees_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"provenance", "tx", "v1", "calculate_msg_based_fee"}, "", runtime.AssumeColonVerbOpt(false)))
)

var (
	forward_Msg_CalculateMsgBasedFees_0 = runtime.ForwardResponseMessage
)
