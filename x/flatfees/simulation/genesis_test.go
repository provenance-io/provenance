...
func TestRandomizedGenState(t *testing.T) {
	...
	// TODO[fees]: Add meaningful checks to this.
	//require.Equal(t, "blah", genState.Params.FloorGasPrice.Denom)
	//require.True(t, genState.Params.FloorGasPrice.Amount.IsPositive())
}
