...
func (s *ScopeKeeperTestSuite) SetupTest() {
	...
	acct3 := s.app.AccountKeeper.NewAccountWithAddress(s.ctx, s.user3Addr)
	s.Require().NoError(acct3.SetSequence(1), "setting account 3 sequence")
	s.app.AccountKeeper.SetAccount(s.ctx, acct3)
