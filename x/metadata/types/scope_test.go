...
func (s *scopeTestSuite) TestEmptyScope() {
	testedFields := []string{}
	tests := []struct {
		field string
		name string
	...
	s.T().Run("All fields are tested", func(t *testing.T) {
		allStructFields := getFieldNames(Scope{})
...
func (s *scopeTestSuite) TestEmptySession() {
	testedFields := []string{}
	tests := []struct {
		field string
		name string
	...
	s.T().Run("All fields are tested", func(t *testing.T) {
		allStructFields := getFieldNames(Session{})
		assertSetsAreEqual(t, testedFields, allStructFields)
	})
}
...
func (s *scopeTestSuite) TestEmptyRecord() {
	testedFields := []string{}
	tests := []struct {
		field string
		name string
	...
	s.T().Run("All fields are tested", func(t *testing.T) {
		allStructFields := getFieldNames(Record{})
		assertSetsAreEqual(t, testedFields, allStructFields)
	})
}

func (s *scopeTestSuite) TestEmptyProcess() {
	testedFields := []string{}
	tests := []struct {
		field string
		name string
	...
	s.T().Run("All fields are tested", func(t *testing.T) {
		allStructFields := getFieldNames(Process{})
		assertSetsAreEqual(t, testedFields, allStructFields)
	})
}
