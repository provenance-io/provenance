...
type LedgerPlainText struct {
	...
	InterestDayCount DayCount `protobuf:"varint,7,opt,name=interest_day_count,json=interestDayCount,proto3,enum=provenance.ledger.v1.DayCount" json:"interest_day_count,omitempty"`
	// The interest accrual method for interest calculations.
	InterestAccrual InterestAccrual `protobuf:"varint,8,opt,name=interest_accrual,json=interestAccrual,proto3,enum=provenance.ledger.v1.InterestAccrual" json:"interest_accrual,omitempty"`
...
func (m *LedgerPlainText) GetInterestDayCount() DayCount {
	if m != nil {
...
func (m *LedgerPlainText) GetInterestAccrual() InterestAccrual {
	if m != nil {
...
var fileDescriptor_2d5ebc9f31c7f052 = []byte{
	...
	,
}
...
func (m *LedgerPlainText) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.InterestAccrual != 0 {
		i = encodeVarintLedgerQuery(dAtA, i, uint64(m.InterestAccrual))
		i--
		dAtA[i] = 0x40
	}
	if m.InterestDayCount != 0 {
		i = encodeVarintLedgerQuery(dAtA, i, uint64(m.InterestDayCount))
		i--
		dAtA[i] = 0x38
	}
...
func (m *LedgerPlainText) Size() (n int) {
	...
	if m.InterestDayCount != 0 {
		n += 1 + sovLedgerQuery(uint64(m.InterestDayCount))
	}
	if m.InterestAccrual != 0 {
		n += 1 + sovLedgerQuery(uint64(m.InterestAccrual))
	}
	if m.PaymentFrequency != 0 {
