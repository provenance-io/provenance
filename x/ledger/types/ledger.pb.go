...
const (
	...
	LEDGER_DAY_COUNT_UNSPECIFIED DayCountConvention = 0
	...
	LEDGER_DAY_COUNT_ACTUAL_365 DayCountConvention = 1
	// Actual/360: Uses the actual number of days in the period but divides by 360.
	LEDGER_DAY_COUNT_ACTUAL_360 DayCountConvention = 2
	// 30/360: Assumes each month has 30 days and the year has 360 days.
	LEDGER_DAY_COUNT_THIRTY_360 DayCountConvention = 3
	...
	LEDGER_DAY_COUNT_ACTUAL_ACTUAL DayCountConvention = 4
	// 365/365: Always uses 365 days in the denominator regardless of leap years.
	LEDGER_DAY_COUNT_DAYS_365 DayCountConvention = 5
	// 360/360: Always uses 360 days in both the numerator and denominator.
	LEDGER_DAY_COUNT_DAYS_360 DayCountConvention = 6
)
...
const (
	...
	LEDGER_ACCRUAL_UNSPECIFIED InterestAccrualMethod = 0
	// Simple Interest: Calculated only on the principal amount.
	LEDGER_ACCRUAL_SIMPLE_INTEREST InterestAccrualMethod = 1
	// Compound Interest: Calculated on both the principal and on previously accumulated interest.
	LEDGER_ACCRUAL_COMPOUND_INTEREST InterestAccrualMethod = 2
	// Daily Compounding: Interest is compounded on a daily basis.
	LEDGER_ACCRUAL_DAILY_COMPOUNDING InterestAccrualMethod = 3
	// Monthly Compounding: Interest is compounded each month.
	LEDGER_ACCRUAL_MONTHLY_COMPOUNDING InterestAccrualMethod = 4
	// Quarterly Compounding: Interest is compounded every quarter.
	LEDGER_ACCRUAL_QUARTERLY_COMPOUNDING InterestAccrualMethod = 5
	// Annually Compounding: Interest is compounded once per year.
	LEDGER_ACCRUAL_ANNUAL_COMPOUNDING InterestAccrualMethod = 6
	// Continuous Compounding: The theoretical limit of compounding frequency where interest is compounded continuously.
	LEDGER_ACCRUAL_CONTINUOUS_COMPOUNDING InterestAccrualMethod = 7
)
...
type Ledger struct {
	...
	InterestDayCountConvention DayCountConvention `protobuf:"varint,8,opt,name=interest_day_count_convention,json=interestDayCountConvention,proto3,enum=provenance.ledger.v1.DayCountConvention" json:"interestDayCountConvention,omitempty"`
	// Interest accrual method for interest
	InterestAccrualMethod InterestAccrualMethod `protobuf:"varint,9,opt,name=interest_accrual_method,json=interestAccrualMethod,proto3,enum=provenance.ledger.v1.InterestAccrualMethod" json:"interestAccrualMethod,omitempty"`
	// Payment frequency
	PaymentFrequency PaymentFrequency `protobuf:"varint,10,opt,name=payment_frequency,json=paymentFrequency,proto3,enum=provenance.ledger.v1.PaymentFrequency" json:"paymentFrequency,omitempty"`
}
...
var fileDescriptor_dee508b012fc2213 = []byte{
	...
	,
}
