...
type EventSmartAccountInit struct {
	...
	CredentialCount uint32 `protobuf:"varint,2,opt,name=credential_count,json=credentialCount,proto3" json:"credential_count,omitempty"`
}
...
func (m *EventSmartAccountInit) GetCredentialCount() uint32 {
	if m != nil {
...
var fileDescriptor_8ae1341371c8c5f5 = []byte{
	...
	0x99, 0x98, 0x13, 0x0f, 0x36, 0x4b, 0x82, 0x49, 0x81, 0x51, 0x83, 0x37, 0x88, 0x1f, 0x21, 0xee,
	...
	0xa5, 0x16, 0x81, 0xed, 0x66, 0x09, 0x42, 0x72, 0x93, 0x1f, 0x58, 0x5c, 0x48, 0x99, 0x8b, 0x17,
	0x49, 0x71, 0x66, 0x8a, 0x04, 0x33, 0xc8, 0x9a, 0x20, 0x1e, 0x84, 0xa0, 0x67, 0x8a, 0x52, 0x35,
	0x97, 0x04, 0xd8, 0x81, 0xce, 0x60, 0x7b, 0xe9, 0xeb, 0x42, 0xa5, 0x0a, 0x68, 0xb4, 0x20, 0xac,
	0x75, 0x49, 0xcd, 0x49, 0x2d, 0x49, 0xa5, 0xb9, 0xcd, 0x4e, 0xc1, 0x27, 0x1e, 0xc9, 0x31, 0x5e,
	...
	0xab, 0x8f, 0x48, 0x6d, 0xba, 0x99, 0xf9, 0x48, 0x3c, 0xfd, 0x0a, 0xb4, 0x74, 0x5a, 0x52, 0x59,
	0x90, 0x5a, 0x9c, 0xc4, 0x06, 0x4e, 0x6c, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xcf, 0x74,
	0xde, 0xc2, 0xd0, 0x02, 0x00, 0x00,
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CredentialCount |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
