...
func (k MsgServer) MarketTransferCommitment(goCtx context.Context, msg *exchange.MsgMarketTransferCommitmentsRequest) (*exchange.MsgMarketTransferCommitmentsResponse, error) {
	ctx := sdk.UnwrapSDKContext(goCtx)
