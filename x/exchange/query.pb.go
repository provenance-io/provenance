...
type QueryGetAccountCommitmentsRequest struct {
	...
	Account string `protobuf:"bytes,1,opt,name=account,proto3" json:"account,omitempty"`
	// Types that are valid to be assigned to XAsset:
	//	*QueryGetAccountCommitmentsRequest_Asset
	XAsset isQueryGetAccountCommitmentsRequest_XAsset `protobuf_oneof:"_asset"`
}
...
type isQueryGetAccountCommitmentsRequest_XAsset interface {
	isQueryGetAccountCommitmentsRequest_XAsset()
	MarshalTo([]byte) (int, error)
	Size() int
}

type QueryGetAccountCommitmentsRequest_Asset struct {
	Asset string `protobuf:"bytes,2,opt,name=asset,proto3,oneof" json:"asset,omitempty"`
}

func (*QueryGetAccountCommitmentsRequest_Asset) isQueryGetAccountCommitmentsRequest_XAsset() {}

func (m *QueryGetAccountCommitmentsRequest) GetXAsset() isQueryGetAccountCommitmentsRequest_XAsset {
	if m != nil {
		return m.XAsset
	}
	return nil
...
func (m *QueryGetAccountCommitmentsRequest) GetAsset() string {
	if x, ok := m.GetXAsset().(*QueryGetAccountCommitmentsRequest_Asset); ok {
		return x.Asset
	}
	return ""
}
...
func (*QueryGetAccountCommitmentsRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*QueryGetAccountCommitmentsRequest_Asset)(nil),
	}
}
...
var fileDescriptor_00949b75b1c10bfe = []byte{
	...
	,
}
	...
	if m.XAsset != nil {
		{
			size := m.XAsset.Size()
			i -= size
			if _, err := m.XAsset.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *QueryGetAccountCommitmentsRequest_Asset) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGetAccountCommitmentsRequest_Asset) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.Asset)
	copy(dAtA[i:], m.Asset)
	i = encodeVarintQuery(dAtA, i, uint64(len(m.Asset)))
...
func (m *QueryGetAccountCommitmentsRequest_Asset) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryGetAccountCommitmentsRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.XAsset = &QueryGetAccountCommitmentsRequest_Asset{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
