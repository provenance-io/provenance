...
* `PERMISSION_CANCEL`: accounts with this permission can use the [CancelOrder](03_messages.md#cancelorder),[MarketReleaseCommitments](03_messages.md#marketreleasecommitments) and [MarketTransferCommitments](03_messages.md#markettransfercommitments) endpoints to cancel orders and release commitments in a market.
