...
type EventCommitmentTransferred struct {
	// current_market_id is the numerical identifier of the market.
	CurrentMarketId uint32 `protobuf:"varint,1,opt,name=current_market_id,json=currentMarketId,proto3" json:"current_market_id,omitempty"`
	// new_market_id is the numerical identifier of the market.
	NewMarketId uint32 `protobuf:"varint,2,opt,name=new_market_id,json=newMarketId,proto3" json:"new_market_id,omitempty"`
	// amount is the coins amount string of funds transfer from the market account.
	Amount string `protobuf:"bytes,3,opt,name=amount,proto3" json:"amount,omitempty"`
...
func (m *EventCommitmentTransferred) Reset()         { *m = EventCommitmentTransferred{} }
func (m *EventCommitmentTransferred) String() string { return proto.CompactTextString(m) }
func (*EventCommitmentTransferred) ProtoMessage()    {}
func (*EventCommitmentTransferred) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1b69385a348cffa, []int{7}
}
func (m *EventCommitmentTransferred) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventCommitmentTransferred) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventCommitmentTransferred.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventCommitmentTransferred) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventCommitmentTransferred.Merge(m, src)
}
func (m *EventCommitmentTransferred) XXX_Size() int {
	return m.Size()
}
func (m *EventCommitmentTransferred) XXX_DiscardUnknown() {
	xxx_messageInfo_EventCommitmentTransferred.DiscardUnknown(m)
}

var xxx_messageInfo_EventCommitmentTransferred proto.InternalMessageInfo

func (m *EventCommitmentTransferred) GetCurrentMarketId() uint32 {
	if m != nil {
...
func (m *EventCommitmentTransferred) GetNewMarketId() uint32 {
	if m != nil {
...
func (m *EventCommitmentTransferred) GetAmount() string {
	if m != nil {
		return m.Amount
	}
	return ""
...
func (m *EventCommitmentTransferred) GetAccount() string {
	if m != nil {
		return m.Account
	}
	return ""
...
func (m *EventCommitmentTransferred) GetTag() string {
	if m != nil {
		return m.Tag
	}
	return ""
...
func (*EventPaymentCancelled) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1b69385a348cffa, []int{28}
}
...
func init() {
	...
	proto.RegisterType((*EventCommitmentTransferred)(nil), "provenance.exchange.v1.EventCommitmentTransferred")
...
var fileDescriptor_c1b69385a348cffa = []byte{
	...
	,
}
...
func (m *EventCommitmentTransferred) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventCommitmentTransferred) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventCommitmentTransferred) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.NewMarketId != 0 {
		i = encodeVarintEvents(dAtA, i, uint64(m.NewMarketId))
		i--
		dAtA[i] = 0x10
	}
	if m.CurrentMarketId != 0 {
		i = encodeVarintEvents(dAtA, i, uint64(m.CurrentMarketId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *EventCommitmentTransferred) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.CurrentMarketId != 0 {
		n += 1 + sovEvents(uint64(m.CurrentMarketId))
	}
	if m.NewMarketId != 0 {
		n += 1 + sovEvents(uint64(m.NewMarketId))
	}
	l = len(m.Amount)
	if l > 0 {
		n += 1 + l + sovEvents(uint64(l))
...
func (m *EventCommitmentTransferred) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventCommitmentTransferred: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventCommitmentTransferred: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
