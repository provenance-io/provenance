...
type Market struct {
	...
	// An entry that starts with "*." will match any attributes that end with the rest of it.
	// E.g. "*.b.a" will match all of "c.b.a", "x.b.a", and "e.d.c.b.a"; but not "b.a", "xb.a", "c.b.x.a", or "c.b.a.x".
	ReqAttrCreateCommitment []string `protobuf:"bytes,17,rep,name=req_attr_create_commitment,json=reqAttrCreateCommitment,proto3" json:"req_attr_create_commitment,omitempty"`
}
...
type AccountAmount struct {
	// address is the bech32 address string associated with the amount.
	Address string `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
...
func (*AccountAmount) Descriptor() ([]byte, []int) {
	return fileDescriptor_d5cf198f1dd7e167, []int{6}
}
...
func (m *AccountAmount) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
type NetAssetPrice struct {
	...
	Assets types1.Coin `protobuf:"bytes,1,opt,name=assets,proto3" json:"assets"`
...
func (*NetAssetPrice) Descriptor() ([]byte, []int) {
	return fileDescriptor_d5cf198f1dd7e167, []int{7}
}
...
func (m *NetAssetPrice) GetAssets() types1.Coin {
	if m != nil {
		return m.Assets
	}
	return types1.Coin{}
...
func (m *NetAssetPrice) GetPrice() types1.Coin {
	if m != nil {
		return m.Price
	}
	return types1.Coin{}
...
var fileDescriptor_d5cf198f1dd7e167 = []byte{
	...
	,
}
