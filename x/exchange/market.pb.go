...
type Market struct {
	...
	// commitment_settlement_intermediary_denom is the denom that the inputs are all converted to (before being converted
	// to the fee denom) during a commitment settlement. Each denom in the inputs must have a NAV to this denom (or be
	// this denom). There must also be a NAV from this denom to the fee denom.
	CommitmentSettlementIntermediaryDenom string `protobuf:"bytes,17,opt,name=commitment_settlement_intermediary_denom,json=commitmentSettlementIntermediaryDenom,proto3" json:"commitment_settlement_intermediary_denom,omitempty"`
...
func (m *Market) GetCommitmentSettlementIntermediaryDenom() string {
	if m != nil {
...
var fileDescriptor_d5cf198f1dd7e167 = []byte{
	...
	,
}
...
func (m *Market) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CommitmentSettlementIntermediaryDenom) > 0 {
		...
		i = encodeVarintMarket(dAtA, i, uint64(len(m.CommitmentSettlementIntermediaryDenom)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x8a
