...
type MsgMarketTransferCommitmentsRequest struct {
	...
	// Types that are valid to be assigned to XCreationFee:
	//
	//	*MsgMarketTransferCommitmentsRequest_CreationFee
	XCreationFee isMsgMarketTransferCommitmentsRequest_XCreationFee `protobuf_oneof:"_creation_fee"`
	// event_tag is a string that is included in the funds-released events. Max length is 100 characters.
	EventTag string `protobuf:"bytes,7,opt,name=event_tag,json=eventTag,proto3" json:"event_tag,omitempty"`
}

func (m *MsgMarketTransferCommitmentsRequest) Reset()         { *m = MsgMarketTransferCommitmentsRequest{} }
func (m *MsgMarketTransferCommitmentsRequest) String() string { return proto.CompactTextString(m) }
func (*MsgMarketTransferCommitmentsRequest) ProtoMessage()    {}
func (*MsgMarketTransferCommitmentsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_e333fcffc093bd1b, []int{18}
}
func (m *MsgMarketTransferCommitmentsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgMarketTransferCommitmentsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgMarketTransferCommitmentsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgMarketTransferCommitmentsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgMarketTransferCommitmentsRequest.Merge(m, src)
}
func (m *MsgMarketTransferCommitmentsRequest) XXX_Size() int {
	return m.Size()
}
func (m *MsgMarketTransferCommitmentsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgMarketTransferCommitmentsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_MsgMarketTransferCommitmentsRequest proto.InternalMessageInfo

type isMsgMarketTransferCommitmentsRequest_XCreationFee interface {
	isMsgMarketTransferCommitmentsRequest_XCreationFee()
	MarshalTo([]byte) (int, error)
	Size() int
}

type MsgMarketTransferCommitmentsRequest_CreationFee struct {
	CreationFee *types.Coin `protobuf:"bytes,6,opt,name=creation_fee,json=creationFee,proto3,oneof" json:"creation_fee,omitempty"`
}

func (*MsgMarketTransferCommitmentsRequest_CreationFee) isMsgMarketTransferCommitmentsRequest_XCreationFee() {
}

func (m *MsgMarketTransferCommitmentsRequest) GetXCreationFee() isMsgMarketTransferCommitmentsRequest_XCreationFee {
	if m != nil {
		return m.XCreationFee
	}
	return nil
}

func (m *MsgMarketTransferCommitmentsRequest) GetAdmin() string {
	if m != nil {
		return m.Admin
	}
	return ""
...
func (m *MsgMarketTransferCommitmentsRequest) GetAccount() string {
	if m != nil {
		return m.Account
	}
	return ""
...
func (m *MsgMarketTransferCommitmentsRequest) GetAmount() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
		return m.Amount
	}
	return nil
...
func (m *MsgMarketTransferCommitmentsRequest) GetCurrentMarketId() uint32 {
	if m != nil {
...
func (m *MsgMarketTransferCommitmentsRequest) GetNewMarketId() uint32 {
	if m != nil {
...
func (m *MsgMarketTransferCommitmentsRequest) GetCreationFee() *types.Coin {
	if x, ok := m.GetXCreationFee().(*MsgMarketTransferCommitmentsRequest_CreationFee); ok {
		return x.CreationFee
	}
	return nil
}

func (m *MsgMarketTransferCommitmentsRequest) GetEventTag() string {
	if m != nil {
		return m.EventTag
	}
	return ""
...
func (*MsgMarketTransferCommitmentsRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*MsgMarketTransferCommitmentsRequest_CreationFee)(nil),
	}
}

// MsgMarketTransferCommitmentsResponse is a response message for the MarketTransferCommitments endpoint.
type MsgMarketTransferCommitmentsResponse struct {
}

func (m *MsgMarketTransferCommitmentsResponse) Reset()         { *m = MsgMarketTransferCommitmentsResponse{} }
func (m *MsgMarketTransferCommitmentsResponse) String() string { return proto.CompactTextString(m) }
func (*MsgMarketTransferCommitmentsResponse) ProtoMessage()    {}
func (*MsgMarketTransferCommitmentsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e333fcffc093bd1b, []int{19}
}
func (m *MsgMarketTransferCommitmentsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgMarketTransferCommitmentsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgMarketTransferCommitmentsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgMarketTransferCommitmentsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgMarketTransferCommitmentsResponse.Merge(m, src)
}
func (m *MsgMarketTransferCommitmentsResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgMarketTransferCommitmentsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgMarketTransferCommitmentsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgMarketTransferCommitmentsResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*MsgMarketTransferCommitmentsRequest)(nil), "provenance.exchange.v1.MsgMarketTransferCommitmentsRequest")
	proto.RegisterType((*MsgMarketTransferCommitmentsResponse)(nil), "provenance.exchange.v1.MsgMarketTransferCommitmentsResponse")
...
var fileDescriptor_e333fcffc093bd1b = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	MarketTransferCommitment(ctx context.Context, in *MsgMarketTransferCommitmentsRequest, opts ...grpc.CallOption) (*MsgMarketTransferCommitmentsResponse, error)
...
func (c *msgClient) MarketTransferCommitment(ctx context.Context, in *MsgMarketTransferCommitmentsRequest, opts ...grpc.CallOption) (*MsgMarketTransferCommitmentsResponse, error) {
	out := new(MsgMarketTransferCommitmentsResponse)
...
type MsgServer interface {
	...
	// MarketTransferCommitment is a market endpoint to transfers committed funds from one market to another.
	MarketTransferCommitment(context.Context, *MsgMarketTransferCommitmentsRequest) (*MsgMarketTransferCommitmentsResponse, error)
	// MarketSetOrderExternalID updates an order's external id field.
...
func (*UnimplementedMsgServer) MarketTransferCommitment(ctx context.Context, req *MsgMarketTransferCommitmentsRequest) (*MsgMarketTransferCommitmentsResponse, error) {
...
func _Msg_MarketTransferCommitment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgMarketTransferCommitmentsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).MarketTransferCommitment(ctx, req.(*MsgMarketTransferCommitmentsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (m *MsgMarketTransferCommitmentsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgMarketTransferCommitmentsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgMarketTransferCommitmentsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.XCreationFee != nil {
		{
			size := m.XCreationFee.Size()
			i -= size
			if _, err := m.XCreationFee.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *MsgMarketTransferCommitmentsRequest_CreationFee) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgMarketTransferCommitmentsRequest_CreationFee) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CreationFee != nil {
		{
			size, err := m.CreationFee.MarshalToSizedBuffer(dAtA[:i])
...
func (m *MsgMarketTransferCommitmentsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgMarketTransferCommitmentsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgMarketTransferCommitmentsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgMarketTransferCommitmentsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgMarketTransferCommitmentsRequest_CreationFee) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgMarketTransferCommitmentsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgMarketTransferCommitmentsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgMarketTransferCommitmentsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgMarketTransferCommitmentsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 6:
			...
			m.XCreationFee = &MsgMarketTransferCommitmentsRequest_CreationFee{v}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EventTag", wireType)
...
func (m *MsgMarketTransferCommitmentsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgMarketTransferCommitmentsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgMarketTransferCommitmentsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
