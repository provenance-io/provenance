...
type MsgMarketWithdrawRequest struct {
	// administrator is the account with withdraw permission requesting the withdrawal.
...
func (m *MsgMarketWithdrawRequest) GetAdministrator() string {
	if m != nil {
...
type MsgMarketManageReqAttrsRequest struct {
	...
	CreateAskToAdd []string `protobuf:"bytes,2,rep,name=create_ask_to_add,json=createAskToAdd,proto3" json:"create_ask_to_add,omitempty"`
	// create_ask_to_add are the attributes that should no longer be required to create an ask order.
	CreateAskToRemove []string `protobuf:"bytes,3,rep,name=create_ask_to_remove,json=createAskToRemove,proto3" json:"create_ask_to_remove,omitempty"`
	// create_ask_to_add are the attributes that should now also be required to create a bid order.
	CreateBidToAdd []string `protobuf:"bytes,4,rep,name=create_bid_to_add,json=createBidToAdd,proto3" json:"create_bid_to_add,omitempty"`
	// create_ask_to_add are the attributes that should no longer be required to create a bid order.
	CreateBidToRemove []string `protobuf:"bytes,5,rep,name=create_bid_to_remove,json=createBidToRemove,proto3" json:"create_bid_to_remove,omitempty"`
}
...
func (m *MsgMarketManageReqAttrsRequest) GetAdministrator() string {
	if m != nil {
		return m.Administrator
	}
	return ""
...
var fileDescriptor_e333fcffc093bd1b = []byte{
	...
	,
}
