...
func (s *IntegrationTestSuite) TestQueryRewardPrograms() {
	testCases := []struct {
		...
		{   name: "query all reward programs",
		    queryTypeArg: 	"all",
		    byId: 	false,
		    expectErrMsg: 	"",
		    expectedCode: 	0,
		...
		{name: "query active reward programs",
			queryTypeArg: "active",
			byId: false,
			expectErrMsg: "",
			expectedCode: 0,
		...
		{name: "query pending reward programs",
			queryTypeArg: "pending",
			byId: false,
			expectErrMsg: "",
			expectedCode: 0,
			expectedIds: []uint64{3, 5},
		},
		{name: "query completed reward programs",
			queryTypeArg: "completed",
			byId: false,
			expectErrMsg: "",
			expectedCode: 0,
			expectedIds: []uint64{2, 4},
		},
		{name: "query outstanding reward programs",
			queryTypeArg: "outstanding",
			byId: false,
			expectErrMsg: "",
			expectedCode: 0,
			expectedIds: []uint64{1, 3, 5},
		},
		{name: "query by id reward programs",
			queryTypeArg: "2",
			byId: true,
			expectErrMsg: "",
			expectedCode: 0,
		...
		{name: "query by id reward programs",
			queryTypeArg: "99",
			byId: true,
			expectErrMsg: "failed to query reward program 99: rpc error: code = Unknown desc = rpc error: code = Internal desc = unable to query for reward program by ID: reward program not found: unknown request",
			expectedCode: 0,
			expectedIds: []uint64{2},
		},
		{name: "query invalid query type",
			queryTypeArg: "invalid",
			byId: true,
			expectErrMsg: "invalid argument arg : invalid",
			expectedCode: 0,
			expectedIds: []uint64{},
		},
	}
...
func (s *IntegrationTestSuite) TestQueryClaimPeriodRewardDistributionAll() {
	...
	testCases := []struct {
		...
		{name: "query all reward programs get default page size of 100",
			args: []string{
				"all",
			},
			byId: false,
			expectErrMsg: "",
			expectedCode: 0,
			expectedIds: defaultMaxQueryIds,
		},
		{name: "query all reward programs max out to default page size",
			args: []string{
				"all",
				"--limit",
				"100",
		...
		{name: "query all reward programs first page with 5 results",
			args: []string{
				"all",
				"--limit",
				"5",
		...
		{name: "query all reward programs second page with 5 results",
			args: []string{
				"all",
				"--limit",
				"5",
		...
		{name: "query by program id and claim period",
			args: []string{
				"1",
				"2",
			},
		...
		{
			name: "query without claim period",
			args: []string{
				"1",
			},
			byId: true,
			expectErrMsg: "a reward_program_id and an claim_period_id are required",
			expectedCode: 0,
			expectedIds: []uint64{},
		},
		{
			name: "query with invalid reward program id format",
			args: []string{
				"1",
				"a",
			},
			byId: true,
			expectErrMsg: "strconv.Atoi: parsing \"a\": invalid syntax",
			expectedCode: 0,
			expectedIds: []uint64{},
		},
		{
		...
		},
		{
			...
			byId: true,
			expectErrMsg: "reward does not exist for reward-id: 100 claim-id 100",
			expectedCode: 0,
			expectedIds: []uint64{},
		},
	}
...
func (s *IntegrationTestSuite) TestGetCmdRewardProgramAdd() {
	...
	testCases := []struct {
		...
		{name: "add reward program tx - valid",
			args: []string{
		...
		{name: "add reward program tx - invalid total-reward-pool",
			args: []string{
				"test add reward program",
				"description",
			...
			expectErrMsg: "invalid decimal coin expression: invalid",
			expectedCode: 0,
		},
		{name: "add reward program tx - invalid max-reward-by-address",
			args: []string{
				"test add reward program",
				"description",
				fmt.Sprintf("--total-reward-pool=580%s", s.cfg.BondDenom),
		...
		{name: "add reward program tx - invalid claim period days",
			args: []string{
				"test add reward program",
				"description",
				fmt.Sprintf("--total-reward-pool=580%s", s.cfg.BondDenom),
			...
			expectErrMsg: "invalid argument \"-1\" for \"--claim-period-days\" flag: strconv.ParseUint: parsing \"-1\": invalid syntax",
			expectedCode: 0,
		},
		{name: "add reward program tx - invalid expire days",
			args: []string{
				"test add reward program",
				"description",
				fmt.Sprintf("--total-reward-pool=580%s", s.cfg.BondDenom),
			...
			expectErrMsg: "invalid argument \"-1\" for \"--expire-days\" flag: strconv.ParseUint: parsing \"-1\": invalid syntax",
			expectedCode: 0,
		},
		{name: "add reward program tx - invalid reward period days",
			args: []string{
				"test add reward program",
				"description",
				fmt.Sprintf("--total-reward-pool=580%s", s.cfg.BondDenom),
			...
			expectErrMsg: "invalid argument \"-52\" for \"--claim-periods\" flag: strconv.ParseUint: parsing \"-52\": invalid syntax",
			expectedCode: 0,
		},
		{name: "add reward program tx - invalid start time",
			args: []string{
				"test add reward program",
				"description",
				fmt.Sprintf("--total-reward-pool=580%s", s.cfg.BondDenom),
			...
			expectErrMsg: "unable to parse time (invalid) required format is RFC3339 (2006-01-02T15:04:05Z07:00) , parsing time \"invalid\" as \"2006-01-02T15:04:05Z07:00\": cannot parse \"invalid\" as \"2006\"",
			expectedCode: 0,
		},
		{name: "add reward program tx - invalid ec",
			args: []string{
				"test add reward program",
				"description",
				fmt.Sprintf("--total-reward-pool=580%s", s.cfg.BondDenom),
			...
			expectErrMsg: "invalid character 'a' looking for beginning of value",
			expectedCode: 0,
		},
		{name: "add reward program tx - invalid type for claim periods",
			args: []string{
				"test add reward program",
				"description",
				fmt.Sprintf("--total-reward-pool=580%s", s.cfg.BondDenom),
			...
			expectErrMsg: "invalid argument \"abc\" for \"--claim-periods\" flag: strconv.ParseUint: parsing \"abc\": invalid syntax",
			expectedCode: 0,
		},
		{name: "add reward program tx - invalid type for claim period days",
			args: []string{
				"test add reward program",
				"description",
				fmt.Sprintf("--total-reward-pool=580%s", s.cfg.BondDenom),
			...
			expectErrMsg: "invalid argument \"abc\" for \"--claim-period-days\" flag: strconv.ParseUint: parsing \"abc\": invalid syntax",
			expectedCode: 0,
		},
		{name: "add reward program tx - invalid type for claim period days",
			args: []string{
			...
			expectErrMsg: "invalid argument \"abc\" for \"--expire-days\" flag: strconv.ParseUint: parsing \"abc\": invalid syntax",
			expectedCode: 0,
		},
		{name: "add reward program tx - invalid type for claim period days",
			args: []string{
			...
			expectErrMsg: "invalid argument \"abc\" for \"--max-rollover-periods\" flag: strconv.ParseUint: parsing \"abc\": invalid syntax",
			expectedCode: 0,
		},
	}
...
func (s *IntegrationTestSuite) TestTxClaimReward() {
	testCases := []struct {
		...
		{name: "claim rewards tx - valid",
		claimRewardArg: 	"1",
		expectErrMsg: 	"",
		expectedCode: 	0,
		},
		{name: "claim rewards tx - all",
			claimRewardArg: "all",
			expectErrMsg: "",
			expectedCode: 0,
		},
