...
type ActionDelegate struct {
	...
	MinimumActiveStakePercentage float64 `protobuf:"fixed64,5,opt,name=minimum_active_stake_percentage,json=minimumActiveStakePercentage,proto3" json:"minimum_active_stake_percentage,omitempty"`
	MaximumActiveStakePercentage float64 `protobuf:"fixed64,6,opt,name=maximum_active_stake_percentage,json=maximumActiveStakePercentage,proto3" json:"maximum_active_stake_percentage,omitempty"`
}
...
func (m *ActionDelegate) GetMinimumActiveStakePercentage() float64 {
	if m != nil {
		return m.MinimumActiveStakePercentage
	}
	return 0
}

func (m *ActionDelegate) GetMaximumActiveStakePercentage() float64 {
	if m != nil {
		return m.MaximumActiveStakePercentage
	}
	return 0
}
...
var fileDescriptor_0c3894741a216575 = []byte{
	...
	,
}
...
func (this *ActionDelegate) Equal(that interface{}) bool {
	...
	if this.MinimumActiveStakePercentage != that1.MinimumActiveStakePercentage {
		return false
	}
	if this.MaximumActiveStakePercentage != that1.MaximumActiveStakePercentage {
		return false
	}
	return true
}
...
func (m *ActionDelegate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.MaximumActiveStakePercentage != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.MaximumActiveStakePercentage))))
		i--
		dAtA[i] = 0x31
	}
	if m.MinimumActiveStakePercentage != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.MinimumActiveStakePercentage))))
		i--
		dAtA[i] = 0x29
	}
...
func (m *ActionDelegate) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinimumActiveStakePercentage", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			iNdEx += 8
			m.MinimumActiveStakePercentage = float64(math.Float64frombits(v))
		case 6:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaximumActiveStakePercentage", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.MaximumActiveStakePercentage = float64(math.Float64frombits(v))
		default:
			iNdEx = preIndex
			skippy, err := skipReward(dAtA[iNdEx:])
			if err != nil {
