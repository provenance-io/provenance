...
type RewardProgram struct {
	...
	EpochSeconds          uint64              `protobuf:"varint,5,opt,name=epoch_seconds,json=epochSeconds,proto3" json:"epoch_seconds,omitempty"`
	...
	FinishedTime          time.Time           `protobuf:"bytes,13,opt,name=finished_time,json=finishedTime,proto3,stdtime" json:"epoch_end_time,omitempty" yaml:"finished_time,omitempty"`
	QualifyingActions     []QualifyingAction  `protobuf:"bytes,14,rep,name=qualifying_actions,json=qualifyingActions,proto3" json:"qualifying_actions" yaml:"qualifying_actions`
	Shares                []Share             `protobuf:"bytes,15,rep,name=shares,proto3" json:"shares" yaml:"shares`
}
...
var fileDescriptor_0c3894741a216575 = []byte{
	...
	,
}
