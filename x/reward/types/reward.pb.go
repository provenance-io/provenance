...
type RewardProgram struct {
	...
	ProgramEndTime        time.Time          `protobuf:"bytes,9,opt,name=program_end_time,json=programEndTime,proto3,stdtime" json:"program_end_time,omitempty" yaml:"program_end_time,omitempty"`
	SubPeriodEndTime      time.Time          `protobuf:"bytes,10,opt,name=sub_period_end_time,json=subPeriodEndTime,proto3,stdtime" json:"epoch_end_time,omitempty" yaml:"epoch_end_time,omitempty"`
	FinishedTime          time.Time          `protobuf:"bytes,11,opt,name=finished_time,json=finishedTime,proto3,stdtime" json:"finished_time,omitempty" yaml:"finished_time,omitempty"`
	SubPeriods            uint64             `protobuf:"varint,12,opt,name=sub_periods,json=subPeriods,proto3" json:"sub_periods,omitempty"`
	CurrentSubPeriod      uint64             `protobuf:"varint,13,opt,name=current_sub_period,json=currentSubPeriod,proto3" json:"current_sub_period,omitempty"`
	Started               bool               `protobuf:"varint,14,opt,name=started,proto3" json:"started,omitempty"`
...
func (m *RewardProgram) GetProgramEndTime() time.Time {
	if m != nil {
...
var fileDescriptor_0c3894741a216575 = []byte{
	...
	,
}
...
func (m *RewardProgram) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x5a
	n2, err2 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.SubPeriodEndTime, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.SubPeriodEndTime):])
	if err2 != nil {
		return 0, err2
	}
	i -= n2
	...
	i--
	dAtA[i] = 0x52
	n3, err3 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.ProgramEndTime, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.ProgramEndTime):])
	if err3 != nil {
		return 0, err3
	}
	i -= n3
