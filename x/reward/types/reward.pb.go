...
type ActionDelegate struct {
	...
	MinimumActiveStakePercentile sdkmath.LegacyDec `protobuf:"bytes,5,opt,name=minimum_active_stake_percentile,json=minimumActiveStakePercentile,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"minimum_active_stake_percentile"`
	// Maximum percentile that can be below the validator's power ranking.
	MaximumActiveStakePercentile sdkmath.LegacyDec `protobuf:"bytes,6,opt,name=maximum_active_stake_percentile,json=maximumActiveStakePercentile,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"maximum_active_stake_percentile"`
}
