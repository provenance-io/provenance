	...
	tests := []struct {
		...
		},
		{
			...
			*NewMsgCreateRewardProgramRequest(
				...
				sdk.NewInt64Coin("jackthecat", 1),
				sdk.NewInt64Coin("jackthecat", 1),
				time.Date(2024, 12, 2, 1, 0, 0, 0, time.UTC),
				1,
				1,
				1,
				qualifyingActions,
			),
			"invalid time must be of date only: 2024-12-02 01:00:00 +0000 UTC",
		},
		{
			"invalid - date has min set",
			*NewMsgCreateRewardProgramRequest(
				"title",
				"description",
				"cosmos1v57fx2l2rt6ehujuu99u2fw05779m5e2ux4z2h",
				sdk.NewInt64Coin("jackthecat", 1),
				sdk.NewInt64Coin("jackthecat", 1),
				time.Date(2024, 12, 2, 0, 1, 0, 0, time.UTC),
				1,
				1,
				1,
				qualifyingActions,
			),
			"invalid time must be of date only: 2024-12-02 00:01:00 +0000 UTC",
		},
		{
			"invalid - date has seconds set",
			*NewMsgCreateRewardProgramRequest(
				"title",
				"description",
				"cosmos1v57fx2l2rt6ehujuu99u2fw05779m5e2ux4z2h",
				sdk.NewInt64Coin("jackthecat", 1),
				sdk.NewInt64Coin("jackthecat", 1),
				time.Date(2024, 12, 2, 0, 0, 1, 0, time.UTC),
				1,
				1,
				1,
				qualifyingActions,
			),
			"invalid time must be of date only: 2024-12-02 00:00:01 +0000 UTC",
		},
		{
			"invalid - date has micro seconds set",
			*NewMsgCreateRewardProgramRequest(
				"title",
				"description",
				"cosmos1v57fx2l2rt6ehujuu99u2fw05779m5e2ux4z2h",
				sdk.NewInt64Coin("jackthecat", 1),
				sdk.NewInt64Coin("jackthecat", 1),
				time.Date(2024, 12, 2, 0, 0, 0, 1, time.UTC),
				1,
				1,
				1,
				qualifyingActions,
			),
			"invalid time must be of date only: 2024-12-02 00:00:00.000000001 +0000 UTC",
		},
		{
