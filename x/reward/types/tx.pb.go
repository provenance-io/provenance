...
type MsgCreateRewardProgramRequest struct {
	...
	ProgramStartTime      time.Time           `protobuf:"bytes,7,opt,name=program_start_time,json=programStartTime,proto3,stdtime" json:"program_start_time,omitempty" yaml:"program_start_time,omitempty"`
	EpochType             string              `protobuf:"bytes,8,opt,name=epoch_type,json=epochType,proto3" json:"epoch_type,omitempty"`
	NumberEpochs          uint64              `protobuf:"varint,9,opt,name=number_epochs,json=numberEpochs,proto3" json:"number_epochs,omitempty"`
...
func (m *MsgCreateRewardProgramRequest) GetRewardProgramId() uint64 {
	if m != nil {
...
var fileDescriptor_6a1c90eb8246d229 = []byte{
	...
	,
}
