...
func (m *MsgBurnAsset) Reset()         { *m = MsgBurnAsset{} }
func (m *MsgBurnAsset) String() string { return proto.CompactTextString(m) }
func (*MsgBurnAsset) ProtoMessage()    {}
func (*MsgBurnAsset) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5b6b5899559789d, []int{1}
}
func (m *MsgBurnAsset) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgBurnAsset) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgBurnAsset.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgBurnAsset) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgBurnAsset.Merge(m, src)
}
func (m *MsgBurnAsset) XXX_Size() int {
	return m.Size()
}
func (m *MsgBurnAsset) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgBurnAsset.DiscardUnknown(m)
}

var xxx_messageInfo_MsgBurnAsset proto.InternalMessageInfo

func (m *MsgBurnAsset) GetAsset() *AssetKey {
	if m != nil {
		return m.Asset
	}
	return nil
...
func (m *MsgBurnAsset) GetSigner() string {
	if m != nil {
		return m.Signer
	}
	return ""
...
// MsgBurnAsset is the message type for creating a new asset.
type MsgBurnAssetResponse struct {
}

func (m *MsgBurnAssetResponse) Reset()         { *m = MsgBurnAssetResponse{} }
func (m *MsgBurnAssetResponse) String() string { return proto.CompactTextString(m) }
func (*MsgBurnAssetResponse) ProtoMessage()    {}
func (*MsgBurnAssetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5b6b5899559789d, []int{2}
}
func (m *MsgBurnAssetResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgBurnAssetResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgBurnAssetResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgBurnAssetResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgBurnAssetResponse.Merge(m, src)
}
func (m *MsgBurnAssetResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgBurnAssetResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgBurnAssetResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgBurnAssetResponse proto.InternalMessageInfo
...
func (*MsgCreateSecuritization) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5b6b5899559789d, []int{10}
}
...
func (*MsgCreateSecuritizationResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5b6b5899559789d, []int{11}
}
...
func init() {
	...
	proto.RegisterType((*MsgBurnAsset)(nil), "provenance.asset.v1.MsgBurnAsset")
	proto.RegisterType((*MsgBurnAssetResponse)(nil), "provenance.asset.v1.MsgBurnAssetResponse")
...
var fileDescriptor_b5b6b5899559789d = []byte{
	...
	,
}
...
func (c *msgClient) BurnAsset(ctx context.Context, in *MsgBurnAsset, opts ...grpc.CallOption) (*MsgBurnAssetResponse, error) {
	out := new(MsgBurnAssetResponse)
	err := c.cc.Invoke(ctx, "/provenance.asset.v1.Msg/BurnAsset", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedMsgServer) BurnAsset(ctx context.Context, req *MsgBurnAsset) (*MsgBurnAssetResponse, error) {
...
func _Msg_BurnAsset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgBurnAsset)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).BurnAsset(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/provenance.asset.v1.Msg/BurnAsset",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).BurnAsset(ctx, req.(*MsgBurnAsset))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Msg_BurnAsset_Handler,
		},
		{
...
func (m *MsgBurnAsset) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgBurnAsset) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgBurnAsset) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgBurnAssetResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgBurnAssetResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgBurnAssetResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgBurnAsset) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgBurnAssetResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgBurnAsset) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgBurnAsset: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgBurnAsset: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgBurnAssetResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgBurnAssetResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgBurnAssetResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
