...
type MsgSetDenomMetadataRequest struct {
	...
	Metadata *github_com_cosmos_cosmos_sdk_x_bank_types.Metadata `protobuf:"bytes,1,opt,name=metadata,proto3,customtype=github.com/cosmos/cosmos-sdk/x/bank/types.Metadata" json:"metadata,omitempty"`
	...
	// coin_name_root is the root of the name of this denomination. SI Prefix strings will be added to this to create the
	// desired denom units.
	CoinNameRoot string `protobuf:"bytes,4,opt,name=coin_name_root,json=coinNameRoot,proto3" json:"coin_name_root,omitempty"`
	...
	AvailablePrefixes []SIPrefix `protobuf:"varint,5,rep,packed,name=available_prefixes,json=availablePrefixes,proto3,enum=provenance.marker.v1.SIPrefix" json:"available_prefixes,omitempty"`
}
...
func (m *MsgSetDenomMetadataRequest) GetDescription() string {
	if m != nil {
...
func (m *MsgSetDenomMetadataRequest) GetCoinNameRoot() string {
	if m != nil {
		return m.CoinNameRoot
	}
	return ""
}

func (m *MsgSetDenomMetadataRequest) GetAvailablePrefixes() []SIPrefix {
	if m != nil {
...
var fileDescriptor_bcb203fb73175ed3 = []byte{
	...
	,
}
...
func (m *MsgSetDenomMetadataRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.AvailablePrefixes) > 0 {
		dAtA6 := make([]byte, len(m.AvailablePrefixes)*10)
		var j5 int
		for _, num := range m.AvailablePrefixes {
			for num >= 1<<7 {
	...
	if len(m.CoinNameRoot) > 0 {
		i -= len(m.CoinNameRoot)
		copy(dAtA[i:], m.CoinNameRoot)
		i = encodeVarintTx(dAtA, i, uint64(len(m.CoinNameRoot)))
		i--
		dAtA[i] = 0x22
	}
...
func (m *MsgSetDenomMetadataRequest) Size() (n int) {
	...
	l = len(m.CoinNameRoot)
	if l > 0 {
		n += 1 + l + sovTx(uint64(l))
	}
	if len(m.AvailablePrefixes) > 0 {
		l = 0
		for _, e := range m.AvailablePrefixes {
			l += sovTx(uint64(e))
		}
...
func (m *MsgSetDenomMetadataRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Metadata == nil {
				m.Metadata = &github_com_cosmos_cosmos_sdk_x_bank_types.Metadata{}
			}
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CoinNameRoot", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CoinNameRoot = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType == 0 {
				var v SIPrefix
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= SIPrefix(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				m.AvailablePrefixes = append(m.AvailablePrefixes, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if elementCount != 0 && len(m.AvailablePrefixes) == 0 {
					m.AvailablePrefixes = make([]SIPrefix, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v SIPrefix
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field AvailablePrefixes", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
