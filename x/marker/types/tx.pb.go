...
type MsgAddMarkerRequest struct {
	...
	MarkerNetAssetValues   []MarkerNetAssetValue                   `protobuf:"bytes,12,rep,name=marker_net_asset_values,json=markerNetAssetValues,proto3" json:"marker_net_asset_values"`
}
...
func (m *MsgAddMarkerRequest) GetMarkerNetAssetValues() []MarkerNetAssetValue {
	if m != nil {
		return m.MarkerNetAssetValues
	}
	return nil
}
...
type MsgAddNetAssetValueRequest struct {
	Denom                string                `protobuf:"bytes,1,opt,name=denom,proto3" json:"denom,omitempty"`
	Administrator        string                `protobuf:"bytes,2,opt,name=administrator,proto3" json:"administrator,omitempty"`
	MarkerNetAssetValues []MarkerNetAssetValue `protobuf:"bytes,3,rep,name=marker_net_asset_values,json=markerNetAssetValues,proto3" json:"marker_net_asset_values"`
}

func (m *MsgAddNetAssetValueRequest) Reset()         { *m = MsgAddNetAssetValueRequest{} }
func (m *MsgAddNetAssetValueRequest) String() string { return proto.CompactTextString(m) }
func (*MsgAddNetAssetValueRequest) ProtoMessage()    {}
func (*MsgAddNetAssetValueRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_bcb203fb73175ed3, []int{40}
}
func (m *MsgAddNetAssetValueRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgAddNetAssetValueRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgAddNetAssetValueRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgAddNetAssetValueRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgAddNetAssetValueRequest.Merge(m, src)
}
func (m *MsgAddNetAssetValueRequest) XXX_Size() int {
	return m.Size()
}
func (m *MsgAddNetAssetValueRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgAddNetAssetValueRequest.DiscardUnknown(m)
}

var xxx_messageInfo_MsgAddNetAssetValueRequest proto.InternalMessageInfo

func (m *MsgAddNetAssetValueRequest) GetDenom() string {
	if m != nil {
		return m.Denom
	}
	return ""
...
func (m *MsgAddNetAssetValueRequest) GetAdministrator() string {
	if m != nil {
		return m.Administrator
	}
	return ""
...
func (m *MsgAddNetAssetValueRequest) GetMarkerNetAssetValues() []MarkerNetAssetValue {
	if m != nil {
		return m.MarkerNetAssetValues
	}
	return nil
...
type MsgAddNetAssetValueResponse struct {
}

func (m *MsgAddNetAssetValueResponse) Reset()         { *m = MsgAddNetAssetValueResponse{} }
func (m *MsgAddNetAssetValueResponse) String() string { return proto.CompactTextString(m) }
func (*MsgAddNetAssetValueResponse) ProtoMessage()    {}
func (*MsgAddNetAssetValueResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bcb203fb73175ed3, []int{41}
}
func (m *MsgAddNetAssetValueResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgAddNetAssetValueResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgAddNetAssetValueResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgAddNetAssetValueResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgAddNetAssetValueResponse.Merge(m, src)
}
func (m *MsgAddNetAssetValueResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgAddNetAssetValueResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgAddNetAssetValueResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgAddNetAssetValueResponse proto.InternalMessageInfo

// MsgDeleteNetAssetValueRequest defines the Msg/DeleteNetAssetValue request type
type MsgDeleteNetAssetValueRequest struct {
	Denom         string   `protobuf:"bytes,1,opt,name=denom,proto3" json:"denom,omitempty"`
	Administrator string   `protobuf:"bytes,2,opt,name=administrator,proto3" json:"administrator,omitempty"`
	ValueDenoms   []string `protobuf:"bytes,3,rep,name=value_denoms,json=valueDenoms,proto3" json:"value_denoms,omitempty"`
}

func (m *MsgDeleteNetAssetValueRequest) Reset()         { *m = MsgDeleteNetAssetValueRequest{} }
func (m *MsgDeleteNetAssetValueRequest) String() string { return proto.CompactTextString(m) }
func (*MsgDeleteNetAssetValueRequest) ProtoMessage()    {}
func (*MsgDeleteNetAssetValueRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_bcb203fb73175ed3, []int{42}
}
func (m *MsgDeleteNetAssetValueRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgDeleteNetAssetValueRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgDeleteNetAssetValueRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgDeleteNetAssetValueRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgDeleteNetAssetValueRequest.Merge(m, src)
}
func (m *MsgDeleteNetAssetValueRequest) XXX_Size() int {
	return m.Size()
}
func (m *MsgDeleteNetAssetValueRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgDeleteNetAssetValueRequest.DiscardUnknown(m)
}

var xxx_messageInfo_MsgDeleteNetAssetValueRequest proto.InternalMessageInfo

func (m *MsgDeleteNetAssetValueRequest) GetDenom() string {
	if m != nil {
		return m.Denom
	}
	return ""
...
func (m *MsgDeleteNetAssetValueRequest) GetAdministrator() string {
	if m != nil {
		return m.Administrator
	}
	return ""
...
func (m *MsgDeleteNetAssetValueRequest) GetValueDenoms() []string {
	if m != nil {
		return m.ValueDenoms
	}
	return nil
}

// MsgDeleteNetAssetValueResponse defines the Msg/DeleteNetAssetValue response type
type MsgDeleteNetAssetValueResponse struct {
}

func (m *MsgDeleteNetAssetValueResponse) Reset()         { *m = MsgDeleteNetAssetValueResponse{} }
func (m *MsgDeleteNetAssetValueResponse) String() string { return proto.CompactTextString(m) }
func (*MsgDeleteNetAssetValueResponse) ProtoMessage()    {}
func (*MsgDeleteNetAssetValueResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bcb203fb73175ed3, []int{43}
}
func (m *MsgDeleteNetAssetValueResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgDeleteNetAssetValueResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgDeleteNetAssetValueResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgDeleteNetAssetValueResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgDeleteNetAssetValueResponse.Merge(m, src)
}
func (m *MsgDeleteNetAssetValueResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgDeleteNetAssetValueResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgDeleteNetAssetValueResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgDeleteNetAssetValueResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*MsgAddNetAssetValueRequest)(nil), "provenance.marker.v1.MsgAddNetAssetValueRequest")
	proto.RegisterType((*MsgAddNetAssetValueResponse)(nil), "provenance.marker.v1.MsgAddNetAssetValueResponse")
	proto.RegisterType((*MsgDeleteNetAssetValueRequest)(nil), "provenance.marker.v1.MsgDeleteNetAssetValueRequest")
	proto.RegisterType((*MsgDeleteNetAssetValueResponse)(nil), "provenance.marker.v1.MsgDeleteNetAssetValueResponse")
}
...
var fileDescriptor_bcb203fb73175ed3 = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	// AddNetAssetValue
	AddNetAssetValue(ctx context.Context, in *MsgAddNetAssetValueRequest, opts ...grpc.CallOption) (*MsgAddNetAssetValueResponse, error)
	// DeleteNetAssetValue
	DeleteNetAssetValue(ctx context.Context, in *MsgDeleteNetAssetValueRequest, opts ...grpc.CallOption) (*MsgDeleteNetAssetValueResponse, error)
}
...
func (c *msgClient) AddNetAssetValue(ctx context.Context, in *MsgAddNetAssetValueRequest, opts ...grpc.CallOption) (*MsgAddNetAssetValueResponse, error) {
	out := new(MsgAddNetAssetValueResponse)
	err := c.cc.Invoke(ctx, "/provenance.marker.v1.Msg/AddNetAssetValue", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeleteNetAssetValue(ctx context.Context, in *MsgDeleteNetAssetValueRequest, opts ...grpc.CallOption) (*MsgDeleteNetAssetValueResponse, error) {
	out := new(MsgDeleteNetAssetValueResponse)
	err := c.cc.Invoke(ctx, "/provenance.marker.v1.Msg/DeleteNetAssetValue", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	// AddNetAssetValue
	AddNetAssetValue(context.Context, *MsgAddNetAssetValueRequest) (*MsgAddNetAssetValueResponse, error)
	// DeleteNetAssetValue
	DeleteNetAssetValue(context.Context, *MsgDeleteNetAssetValueRequest) (*MsgDeleteNetAssetValueResponse, error)
}
...
func (*UnimplementedMsgServer) AddNetAssetValue(ctx context.Context, req *MsgAddNetAssetValueRequest) (*MsgAddNetAssetValueResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddNetAssetValue not implemented")
}
func (*UnimplementedMsgServer) DeleteNetAssetValue(ctx context.Context, req *MsgDeleteNetAssetValueRequest) (*MsgDeleteNetAssetValueResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteNetAssetValue not implemented")
}
...
func _Msg_AddNetAssetValue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgAddNetAssetValueRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).AddNetAssetValue(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/provenance.marker.v1.Msg/AddNetAssetValue",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).AddNetAssetValue(ctx, req.(*MsgAddNetAssetValueRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Msg_DeleteNetAssetValue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgDeleteNetAssetValueRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).DeleteNetAssetValue(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/provenance.marker.v1.Msg/DeleteNetAssetValue",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).DeleteNetAssetValue(ctx, req.(*MsgDeleteNetAssetValueRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddNetAssetValue",
			Handler:    _Msg_AddNetAssetValue_Handler,
		},
		{
			MethodName: "DeleteNetAssetValue",
			Handler:    _Msg_DeleteNetAssetValue_Handler,
		},
	},
...
func (m *MsgAddMarkerRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.MarkerNetAssetValues) > 0 {
		for iNdEx := len(m.MarkerNetAssetValues) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.MarkerNetAssetValues[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *MsgAddNetAssetValueRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgAddNetAssetValueRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgAddNetAssetValueRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgAddNetAssetValueResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgAddNetAssetValueResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgAddNetAssetValueResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgDeleteNetAssetValueRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgDeleteNetAssetValueRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgDeleteNetAssetValueRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.ValueDenoms) > 0 {
		for iNdEx := len(m.ValueDenoms) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ValueDenoms[iNdEx])
			copy(dAtA[i:], m.ValueDenoms[iNdEx])
			i = encodeVarintTx(dAtA, i, uint64(len(m.ValueDenoms[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
...
func (m *MsgDeleteNetAssetValueResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgDeleteNetAssetValueResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgDeleteNetAssetValueResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgAddMarkerRequest) Size() (n int) {
	...
	if len(m.MarkerNetAssetValues) > 0 {
		for _, e := range m.MarkerNetAssetValues {
			l = e.Size()
			n += 1 + l + sovTx(uint64(l))
		}
	}
...
func (m *MsgAddNetAssetValueRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgAddNetAssetValueResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgDeleteNetAssetValueRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgDeleteNetAssetValueResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgAddMarkerRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MarkerNetAssetValues", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MarkerNetAssetValues = append(m.MarkerNetAssetValues, MarkerNetAssetValue{})
			if err := m.MarkerNetAssetValues[len(m.MarkerNetAssetValues)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *MsgAddNetAssetValueRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgAddNetAssetValueRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgAddNetAssetValueRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgAddNetAssetValueResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgAddNetAssetValueResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgAddNetAssetValueResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *MsgDeleteNetAssetValueRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgDeleteNetAssetValueRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgDeleteNetAssetValueRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ValueDenoms", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ValueDenoms = append(m.ValueDenoms, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
...
func (m *MsgDeleteNetAssetValueResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgDeleteNetAssetValueResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgDeleteNetAssetValueResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
