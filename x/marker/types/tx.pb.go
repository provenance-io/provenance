...
type MsgReflectMarkerRequest struct {
	MarkerDenom   string `protobuf:"bytes,1,opt,name=marker_denom,json=markerDenom,proto3" json:"marker_denom,omitempty"`
	IbcDenom      string `protobuf:"bytes,2,opt,name=ibc_denom,json=ibcDenom,proto3" json:"ibc_denom,omitempty"`
	ConnectionId  string `protobuf:"bytes,3,opt,name=connection_id,json=connectionId,proto3" json:"connection_id,omitempty"`
	Administrator string `protobuf:"bytes,4,opt,name=administrator,proto3" json:"administrator,omitempty"`
}
...
func (m *MsgReflectMarkerRequest) GetMarkerDenom() string {
	if m != nil {
		return m.MarkerDenom
	}
	return ""
}
...
func (m *MsgReflectMarkerRequest) GetConnectionId() string {
	if m != nil {
...
type MsgIcaReflectMarkerRequest struct {
	MarkerDenom string `protobuf:"bytes,1,opt,name=marker_denom,json=markerDenom,proto3" json:"marker_denom,omitempty"`
	IbcDenom    string `protobuf:"bytes,2,opt,name=ibc_denom,json=ibcDenom,proto3" json:"ibc_denom,omitempty"`
	...
	AccessControl []AccessGrant `protobuf:"bytes,6,rep,name=access_control,json=accessControl,proto3" json:"access_control"`
	// indicates that governance based control is allowed for this marker
	AllowGovernanceControl bool   `protobuf:"varint,7,opt,name=allow_governance_control,json=allowGovernanceControl,proto3" json:"allow_governance_control,omitempty"`
	Owner                  string `protobuf:"bytes,8,opt,name=owner,proto3" json:"owner,omitempty"`
}

func (m *MsgIcaReflectMarkerRequest) Reset()         { *m = MsgIcaReflectMarkerRequest{} }
func (m *MsgIcaReflectMarkerRequest) String() string { return proto.CompactTextString(m) }
func (*MsgIcaReflectMarkerRequest) ProtoMessage()    {}
func (*MsgIcaReflectMarkerRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_bcb203fb73175ed3, []int{30}
}
func (m *MsgIcaReflectMarkerRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgIcaReflectMarkerRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgIcaReflectMarkerRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgIcaReflectMarkerRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgIcaReflectMarkerRequest.Merge(m, src)
}
func (m *MsgIcaReflectMarkerRequest) XXX_Size() int {
	return m.Size()
}
func (m *MsgIcaReflectMarkerRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgIcaReflectMarkerRequest.DiscardUnknown(m)
}

var xxx_messageInfo_MsgIcaReflectMarkerRequest proto.InternalMessageInfo

func (m *MsgIcaReflectMarkerRequest) GetMarkerDenom() string {
	if m != nil {
		return m.MarkerDenom
	}
	return ""
...
func (m *MsgIcaReflectMarkerRequest) GetIbcDenom() string {
	if m != nil {
		return m.IbcDenom
	}
	return ""
...
func (m *MsgIcaReflectMarkerRequest) GetInvoker() string {
	if m != nil {
		return m.Invoker
	}
	return ""
...
func (m *MsgIcaReflectMarkerRequest) GetStatus() MarkerStatus {
	if m != nil {
		return m.Status
	}
	return StatusUndefined
...
func (m *MsgIcaReflectMarkerRequest) GetMarkerType() MarkerType {
	if m != nil {
		return m.MarkerType
	}
	return MarkerType_Unknown
...
func (m *MsgIcaReflectMarkerRequest) GetAccessControl() []AccessGrant {
	if m != nil {
...
func (m *MsgIcaReflectMarkerRequest) GetAllowGovernanceControl() bool {
	if m != nil {
		return m.AllowGovernanceControl
	}
	return false
...
func (m *MsgIcaReflectMarkerRequest) GetOwner() string {
	if m != nil {
		return m.Owner
	}
	return ""
...
type MsgIcaReflectMarkerResponse struct {
}

func (m *MsgIcaReflectMarkerResponse) Reset()         { *m = MsgIcaReflectMarkerResponse{} }
func (m *MsgIcaReflectMarkerResponse) String() string { return proto.CompactTextString(m) }
func (*MsgIcaReflectMarkerResponse) ProtoMessage()    {}
func (*MsgIcaReflectMarkerResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bcb203fb73175ed3, []int{31}
}
func (m *MsgIcaReflectMarkerResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgIcaReflectMarkerResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgIcaReflectMarkerResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgIcaReflectMarkerResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgIcaReflectMarkerResponse.Merge(m, src)
}
func (m *MsgIcaReflectMarkerResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgIcaReflectMarkerResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgIcaReflectMarkerResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgIcaReflectMarkerResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*MsgIcaReflectMarkerRequest)(nil), "provenance.marker.v1.MsgIcaReflectMarkerRequest")
	proto.RegisterType((*MsgIcaReflectMarkerResponse)(nil), "provenance.marker.v1.MsgIcaReflectMarkerResponse")
}
...
var fileDescriptor_bcb203fb73175ed3 = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	// IcaReflectMarker is used to create a marker on the host chain using ica that
	// reflects the marker on the controller chain
	IcaReflectMarker(ctx context.Context, in *MsgIcaReflectMarkerRequest, opts ...grpc.CallOption) (*MsgIcaReflectMarkerResponse, error)
}
...
func (c *msgClient) IcaReflectMarker(ctx context.Context, in *MsgIcaReflectMarkerRequest, opts ...grpc.CallOption) (*MsgIcaReflectMarkerResponse, error) {
	out := new(MsgIcaReflectMarkerResponse)
	err := c.cc.Invoke(ctx, "/provenance.marker.v1.Msg/IcaReflectMarker", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	// IcaReflectMarker is used to create a marker on the host chain using ica that
	// reflects the marker on the controller chain
	IcaReflectMarker(context.Context, *MsgIcaReflectMarkerRequest) (*MsgIcaReflectMarkerResponse, error)
}
...
func (*UnimplementedMsgServer) IcaReflectMarker(ctx context.Context, req *MsgIcaReflectMarkerRequest) (*MsgIcaReflectMarkerResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IcaReflectMarker not implemented")
}
...
func _Msg_IcaReflectMarker_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgIcaReflectMarkerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).IcaReflectMarker(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/provenance.marker.v1.Msg/IcaReflectMarker",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).IcaReflectMarker(ctx, req.(*MsgIcaReflectMarkerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "IcaReflectMarker",
			Handler:    _Msg_IcaReflectMarker_Handler,
		},
	},
...
func (m *MsgReflectMarkerRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.MarkerDenom) > 0 {
		i -= len(m.MarkerDenom)
		copy(dAtA[i:], m.MarkerDenom)
		i = encodeVarintTx(dAtA, i, uint64(len(m.MarkerDenom)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *MsgIcaReflectMarkerRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgIcaReflectMarkerRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgIcaReflectMarkerRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgIcaReflectMarkerResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgIcaReflectMarkerResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgIcaReflectMarkerResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgIcaReflectMarkerRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgIcaReflectMarkerResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgReflectMarkerRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MarkerDenom", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MarkerDenom = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
...
func (m *MsgIcaReflectMarkerRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgIcaReflectMarkerRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgIcaReflectMarkerRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgIcaReflectMarkerResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgIcaReflectMarkerResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgIcaReflectMarkerResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
