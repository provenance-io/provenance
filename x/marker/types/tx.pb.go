...
type MsgUpdateRequiredAttributesRequest struct {
	RemoveRequiredAttributes []string `protobuf:"bytes,1,rep,name=remove_required_attributes,json=removeRequiredAttributes,proto3" json:"remove_required_attributes,omitempty"`
	AddRequiredAttributes    []string `protobuf:"bytes,2,rep,name=add_required_attributes,json=addRequiredAttributes,proto3" json:"add_required_attributes,omitempty"`
	TransferAuthority        string   `protobuf:"bytes,3,opt,name=transfer_authority,json=transferAuthority,proto3" json:"transfer_authority,omitempty"`
}
...
var fileDescriptor_bcb203fb73175ed3 = []byte{
	...
	,
}
