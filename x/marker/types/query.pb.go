...
func (m *QueryNetAssetValuesRequest) String() string { return proto.CompactTextString(m) }
func (*QueryNetAssetValuesRequest) ProtoMessage()    {}
func (*QueryNetAssetValuesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_a76fb1fac8494cdc, []int{19}
}
...
func (m *QueryNetAssetValuesRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryNetAssetValuesRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryNetAssetValuesRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryNetAssetValuesRequest.Merge(m, src)
}
func (m *QueryNetAssetValuesRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryNetAssetValuesRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryNetAssetValuesRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryNetAssetValuesRequest proto.InternalMessageInfo

func (m *QueryNetAssetValuesRequest) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *QueryNetAssetValuesResponse) String() string { return proto.CompactTextString(m) }
func (*QueryNetAssetValuesResponse) ProtoMessage()    {}
func (*QueryNetAssetValuesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a76fb1fac8494cdc, []int{20}
}
...
func (m *QueryNetAssetValuesResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryNetAssetValuesResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryNetAssetValuesResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryNetAssetValuesResponse.Merge(m, src)
}
func (m *QueryNetAssetValuesResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryNetAssetValuesResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryNetAssetValuesResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryNetAssetValuesResponse proto.InternalMessageInfo
...
func (m *QueryMarkerFeeGrantsRequest) Reset()         { *m = QueryMarkerFeeGrantsRequest{} }
func (m *QueryMarkerFeeGrantsRequest) String() string { return proto.CompactTextString(m) }
func (*QueryMarkerFeeGrantsRequest) ProtoMessage()    {}
func (*QueryMarkerFeeGrantsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_a76fb1fac8494cdc, []int{21}
}
func (m *QueryMarkerFeeGrantsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryMarkerFeeGrantsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryMarkerFeeGrantsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryMarkerFeeGrantsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryMarkerFeeGrantsRequest.Merge(m, src)
}
func (m *QueryMarkerFeeGrantsRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryMarkerFeeGrantsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryMarkerFeeGrantsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryMarkerFeeGrantsRequest proto.InternalMessageInfo

func (m *QueryMarkerFeeGrantsRequest) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *QueryMarkerFeeGrantsRequest) GetPagination() *query.PageRequest {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func (m *QueryMarkerFeeGrantsResponse) Reset()         { *m = QueryMarkerFeeGrantsResponse{} }
func (m *QueryMarkerFeeGrantsResponse) String() string { return proto.CompactTextString(m) }
func (*QueryMarkerFeeGrantsResponse) ProtoMessage()    {}
func (*QueryMarkerFeeGrantsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a76fb1fac8494cdc, []int{22}
}
func (m *QueryMarkerFeeGrantsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryMarkerFeeGrantsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryMarkerFeeGrantsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryMarkerFeeGrantsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryMarkerFeeGrantsResponse.Merge(m, src)
}
func (m *QueryMarkerFeeGrantsResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryMarkerFeeGrantsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryMarkerFeeGrantsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryMarkerFeeGrantsResponse proto.InternalMessageInfo

func (m *QueryMarkerFeeGrantsResponse) GetGrants() []*feegrant.Grant {
	if m != nil {
		return m.Grants
	}
	return nil
...
func (m *QueryMarkerFeeGrantsResponse) GetPagination() *query.PageResponse {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*QueryMarkerFeeGrantsRequest)(nil), "provenance.marker.v1.QueryMarkerFeeGrantsRequest")
	proto.RegisterType((*QueryMarkerFeeGrantsResponse)(nil), "provenance.marker.v1.QueryMarkerFeeGrantsResponse")
}
...
var fileDescriptor_a76fb1fac8494cdc = []byte{
	...
	,
}
...
func (c *queryClient) MarkerFeeGrants(ctx context.Context, in *QueryMarkerFeeGrantsRequest, opts ...grpc.CallOption) (*QueryMarkerFeeGrantsResponse, error) {
	out := new(QueryMarkerFeeGrantsResponse)
	err := c.cc.Invoke(ctx, "/provenance.marker.v1.Query/MarkerFeeGrants", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedQueryServer) MarkerFeeGrants(ctx context.Context, req *QueryMarkerFeeGrantsRequest) (*QueryMarkerFeeGrantsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MarkerFeeGrants not implemented")
}
...
func _Query_MarkerFeeGrants_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryMarkerFeeGrantsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).MarkerFeeGrants(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/provenance.marker.v1.Query/MarkerFeeGrants",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).MarkerFeeGrants(ctx, req.(*QueryMarkerFeeGrantsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "MarkerFeeGrants",
			Handler:    _Query_MarkerFeeGrants_Handler,
		},
	},
...
func (m *QueryMarkerFeeGrantsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryMarkerFeeGrantsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryMarkerFeeGrantsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryMarkerFeeGrantsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryMarkerFeeGrantsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryMarkerFeeGrantsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryMarkerFeeGrantsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryMarkerFeeGrantsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryMarkerFeeGrantsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryMarkerFeeGrantsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryMarkerFeeGrantsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryMarkerFeeGrantsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryMarkerFeeGrantsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryMarkerFeeGrantsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Grants = append(m.Grants, &feegrant.Grant{})
