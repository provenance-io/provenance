...
type MarkerAccount struct {
	...
	*types.BaseAccount `protobuf:"bytes,1,opt,name=base_account,json=baseAccount,proto3,embedded=base_account" json:"base_account,omitempty" yaml:"base_account"`
	...
	// list of bech32 addresses that are denied the ability to send the restricted marker
	SendDenyList []string `protobuf:"bytes,12,rep,name=send_deny_list,json=sendDenyList,proto3" json:"send_deny_list,omitempty"`
}
...
var fileDescriptor_f7e2c25c71db7f99 = []byte{
	...
	,
}
...
func (m *MarkerAccount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SendDenyList) > 0 {
		for iNdEx := len(m.SendDenyList) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintMarker(dAtA, i, uint64(len(m.SendDenyList[iNdEx])))
			i--
			dAtA[i] = 0x62
		}
	}
