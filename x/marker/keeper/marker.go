...
func (k Keeper) GetAllMarkerHolders(ctx sdk.Context, denom string) []types.Balance {
	defer telemetry.MeasureSince(time.Now(), types.ModuleName, types.EventTelemetryKeyKeeperMethod, "get_all_marker_holders")
...
func (k Keeper) GetMarkerByDenom(ctx sdk.Context, denom string) (types.MarkerAccountI, error) {
	defer telemetry.MeasureSince(time.Now(), types.ModuleName, types.EventTelemetryKeyKeeperMethod, "get_marker_by_denom")
...
func (k Keeper) AddMarkerAccount(ctx sdk.Context, marker types.MarkerAccountI) error {
	defer telemetry.MeasureSince(time.Now(), types.ModuleName, types.EventTelemetryKeyKeeperMethod, "add_marker_account")
...
func (k Keeper) AddAccess(
	...
	defer telemetry.MeasureSince(time.Now(), types.ModuleName, types.EventTelemetryKeyKeeperMethod, "add_access")
...
func (k Keeper) RemoveAccess(ctx sdk.Context, caller sdk.AccAddress, denom string, remove sdk.AccAddress) error {
	defer telemetry.MeasureSince(time.Now(), types.ModuleName, types.EventTelemetryKeyKeeperMethod, "remove_access")
...
func (k Keeper) WithdrawCoins(
	...
	defer telemetry.MeasureSince(time.Now(), types.ModuleName, types.EventTelemetryKeyKeeperMethod, "withdraw_coins")
...
func (k Keeper) MintCoin(ctx sdk.Context, caller sdk.AccAddress, coin sdk.Coin) error {
	defer telemetry.MeasureSince(time.Now(), types.ModuleName, types.EventTelemetryKeyKeeperMethod, "mint_coin")
...
func (k Keeper) BurnCoin(ctx sdk.Context, caller sdk.AccAddress, coin sdk.Coin) error {
	defer telemetry.MeasureSince(time.Now(), types.ModuleName, types.EventTelemetryKeyKeeperMethod, "burn_coin")
...
func (k Keeper) AdjustCirculation(ctx sdk.Context, marker types.MarkerAccountI, desiredSupply sdk.Coin) error {
	defer telemetry.MeasureSince(time.Now(), types.ModuleName, types.EventTelemetryKeyKeeperMethod, "adjust_circulation")
...
func (k Keeper) IncreaseSupply(ctx sdk.Context, marker types.MarkerAccountI, coin sdk.Coin) error {
	defer telemetry.MeasureSince(time.Now(), types.ModuleName, types.EventTelemetryKeyKeeperMethod, "increase_supply")
...
func (k Keeper) DecreaseSupply(ctx sdk.Context, marker types.MarkerAccountI, coin sdk.Coin) error {
	defer telemetry.MeasureSince(time.Now(), types.ModuleName, types.EventTelemetryKeyKeeperMethod, "decrease_supply")
...
func (k Keeper) FinalizeMarker(ctx sdk.Context, caller sdk.Address, denom string) error {
	defer telemetry.MeasureSince(time.Now(), types.ModuleName, types.EventTelemetryKeyKeeperMethod, "finalize_marker")
...
func (k Keeper) ActivateMarker(ctx sdk.Context, caller sdk.Address, denom string) error {
	defer telemetry.MeasureSince(time.Now(), types.ModuleName, types.EventTelemetryKeyKeeperMethod, "activate_marker")
...
func (k Keeper) CancelMarker(ctx sdk.Context, caller sdk.AccAddress, denom string) error {
	defer telemetry.MeasureSince(time.Now(), types.ModuleName, types.EventTelemetryKeyKeeperMethod, "cancel_marker")
...
func (k Keeper) DeleteMarker(ctx sdk.Context, caller sdk.AccAddress, denom string) error {
	defer telemetry.MeasureSince(time.Now(), types.ModuleName, types.EventTelemetryKeyKeeperMethod, "delete_marker")
...
func (k Keeper) TransferCoin(ctx sdk.Context, from, to, admin sdk.AccAddress, amount sdk.Coin) error {
	defer telemetry.MeasureSince(time.Now(), types.ModuleName, types.EventTelemetryKeyKeeperMethod, "transfer_coin")
...
func (k Keeper) SetMarkerDenomMetadata(ctx sdk.Context, metadata banktypes.Metadata, caller sdk.AccAddress) error {
	defer telemetry.MeasureSince(time.Now(), types.ModuleName, types.EventTelemetryKeyKeeperMethod, "set_marker_denom_metadata")
