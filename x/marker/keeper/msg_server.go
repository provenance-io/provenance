...
func (k msgServer) GrantAllowance(goCtx context.Context, msg *types.MsgGrantAllowanceRequest) (*types.MsgGrantAllowanceResponse, error) {
	...
	if err = k.Keeper.ValidateHasAccess(ctx, m.GetAddress(), admin, types.Access_Admin); err != nil {
...
func (k msgServer) UpdateRequiredAttributes(goCtx context.Context, msg *types.MsgUpdateRequiredAttributesRequest) (*types.MsgUpdateRequiredAttributesResponse, error) {
	...
	case !k.Keeper.HasAccess(ctx, m.GetAddress(), caller, types.Access_Transfer):
...
func (k msgServer) UpdateRequireDepositAccess(goCtx context.Context, msg *types.MsgUpdateRequireDepositAccessRequest) (*types.MsgUpdateRequireDepositAccessResponse, error) {
	...
	case !k.Keeper.HasAccess(ctx, marker.GetAddress(), caller, types.Access_Admin):
