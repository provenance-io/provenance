...
var (
	ErrEventNotFound           = cerrs.Register(ModuleName, 3, "event not found")       //nolint:revive
	ErrQueueIndexNotFound      = cerrs.Register(ModuleName, 4, "queue index not found") //nolint:revive
