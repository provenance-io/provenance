...
A `Trigger` is the main data structure used by the module. It keeps track of the owner, event, and actions for a single `Trigger`. Every `Trigger` gets its own unique identifier, and a unique entry within the `Event Listener`. The `Event Listener` table allows the event detection system to quickly filter applicable `Triggers` by name and type.
...
+++ https://github.com/provenance-io/provenance/blob/v1.26.0/proto/provenance/trigger/v1/trigger.proto#L13-L25
...
+++ https://github.com/provenance-io/provenance/blob/v1.26.0/proto/provenance/trigger/v1/trigger.proto#L39-L46
...
+++ https://github.com/provenance-io/provenance/blob/v1.26.0/proto/provenance/trigger/v1/trigger.proto#L48-L55
...
+++ https://github.com/provenance-io/provenance/blob/v1.26.0/proto/provenance/trigger/v1/trigger.proto#L57-L66
...
+++ https://github.com/provenance-io/provenance/blob/v1.26.0/proto/provenance/trigger/v1/trigger.proto#L68-L76
...
+++ https://github.com/provenance-io/provenance/blob/v1.26.0/proto/provenance/trigger/v1/trigger.proto#L27-L37
