...
const (
	...
	// REGISTRY_ROLE_SECURED_PARTY indicates the address has secured party privileges
	RegistryRole_REGISTRY_ROLE_SECURED_PARTY RegistryRole = 5
	// ROLE_BORROWER indicates the address has borrower privileges
	RegistryRole_REGISTRY_ROLE_BORROWER RegistryRole = 6
)
...
var RegistryRole_name = map[int32]string{
	...
	5: "REGISTRY_ROLE_SECURED_PARTY",
	6: "REGISTRY_ROLE_BORROWER",
}
...
var RegistryRole_value = map[string]int32{
	...
	"REGISTRY_ROLE_SECURED_PARTY": 5,
	"REGISTRY_ROLE_BORROWER":      6,
}
...
var fileDescriptor_2fa7a0b4d34d0208 = []byte{
	...
	,
}
